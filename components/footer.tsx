...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#011d54] text-primary-foreground">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-4 text-primary-foreground/80 text-sm leading-relaxed">
                Delivering marine supply and logistics solutions through experience, efficiency, and environmental responsibility.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <a href="tel:+201027227142" className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title="Call">
                  <Phone className="w-4 h-4 text-accent" />
                </a>
                <a href="https://wa.me/+201097178002" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title="WhatsApp">
          ...
          {/* Useful Links */}
          <div>
            <h3 className="font-bold text-lg text-accent tracking-wide uppercase">Useful Links</h3>
            <div className="h-0.5 w-10 bg-accent mb-6 mt-2" />
            <ul className="space-y-4 text-sm text-primary-foreground/80">
              <li>
                <a
                  href="https://www.enhd.gov.eg/"
                  target="_blank"
          ...
          {/* Reach Us */}
          <div>
            <h3 className="font-bold text-lg text-accent tracking-wide uppercase">Reach Us</h3>
            <div className="h-0.5 w-10 bg-accent mb-6 mt-2" />
            <div className="space-y-6">
              <ul className="space-y-4 text-sm text-primary-foreground/80">
                ...
                <li className="flex items-center gap-3 group">
                  ...
                  <a href="tel:" className="hover:underline">+201027227142</a>
                </li>
                <li className="flex items-center gap-3 group">
                  <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-gray-200 dark:group-hover:bg-gray-700 transition-colors">
                    <MessageCircle className="w-4 h-4 text-accent" />
                  </div>
                  <a href="https://wa.me/+201097178002" target="_blank" rel="noopener noreferrer" className="hover:underline">+201097178002</a>
                </li>
                <li className="flex items-center gap-3 group">
                  <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-gray-200 dark:group-hover:bg-gray-700 transition-colors">
                    <Mail className="w-4 h-4 text-accent" />
